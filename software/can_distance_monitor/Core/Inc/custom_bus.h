...
#define BUS_I2C2_SDA_GPIO_PIN GPIO_PIN_6
#define BUS_I2C2_SDA_GPIO_AF GPIO_AF8_I2C2
#define BUS_I2C2_SCL_GPIO_AF GPIO_AF8_I2C2
#define BUS_I2C2_SCL_GPIO_PORT GPIOA
#define BUS_I2C2_SCL_GPIO_CLK_DISABLE() __HAL_RCC_GPIOA_CLK_DISABLE()
#define BUS_I2C2_SCL_GPIO_PIN GPIO_PIN_9
